...
const events = [
  { no: "01", tag: "RECURRING", title: "Prayer Stretches", date: "3× Monthly", location: "Bixby, OK", line: "Intercession for our generation, our city, our nation, and the global church.", color: "#A9C0BF" },
  { no: "02", tag: "ANNUAL", title: "Activate 2026", date: "October 2-3 · 2026", location: "Bixby, OK", line: "A two-day revival and equipping gathering shaped by worship, prayer, commissioning and discipleship.", color: "#A9C0BF" },
  { no: "03", tag: "END OF YEAR", title: "Crossover 2027", date: "Dec 31 · 9 PM", location: "Bixby, OK", line: "Step into 2027 in His presence — worship, prayer, prophetic declaration.", color: "#E66839" },
]
    ...
    <section id="events" ref={ref} data-scene="gather-hero" className="relative" style={{ ["--stage-vh" as string]: "200vh", height: "var(--stage-vh)" }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(to top, #000000 0%, rgba(0,0,0,0.48) 45%, rgba(0,0,0,0.18) 100%)",
            opacity: overlayOp,
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#000000]/50 via-transparent to-transparent pointer-events-none" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-end max-w-[1280px] mx-auto px-6 md:px-12 pb-20 md:pb-28">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <motion.span
              className="h-px w-16 bg-[#D85325]/45 origin-left"
          ...
          {/* Title — word by word */}
          <h2
            className="text-[3.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[9rem] font-bold leading-[0.92] tracking-[-0.02em] text-[#FFFFED]"
          ...
          {/* Italic line */}
          <p className="mt-5 max-w-2xl text-xl md:text-2xl italic text-[#FFFFED]/85 leading-snug" style={{ fontFamily: "var(--font-display)" }}>
          ...
          >
            <span className="text-[#FFFFED]/85">{featured.date}</span>
...
function ScheduleRow({
  ...
  return (
    <motion.li
      className="group relative grid md:grid-cols-[80px_1fr_auto] gap-4 md:gap-10 items-center py-7 md:py-9 border-b border-[rgba(255,255,255,0.11)] hover:border-[rgba(216,83,37,0.4)] transition-colors duration-500 cursor-pointer"
      style={{ opacity, x }}
    >
      ...
      <div>
        <div
          className="text-3xl md:text-5xl font-bold leading-tight tracking-[-0.01em] text-[#FFFFED] group-hover:text-white transition-colors duration-300"
          style={{ fontFamily: "var(--font-display)" }}
        >
          {event.title}
        </div>
        <p className="mt-2 text-[#8A8280] group-hover:text-[#FFFFED]/90 text-sm md:text-base max-w-xl leading-relaxed transition-colors duration-300" style={{ fontFamily: "var(--font-sans)" }}>
          {event.line}
        </p>
      </div>

      <div className="flex items-center gap-4 md:flex-col md:items-end md:gap-1">
        <div className="text-[#FFFFED]/90 text-sm" style={{ fontFamily: "var(--font-mono)" }}>{event.date}</div>
        <div className="hidden md:block text-[#8A8280]/75 text-[10px] tracking-[0.3em] uppercase" style={{ fontFamily: "var(--font-mono)" }}>
          {event.location}
        </div>
        <ArrowUpRight
          size={20}
          className="text-[#8A8280]/80 group-hover:text-[#D85325] group-hover:translate-x-1.5 group-hover:-translate-y-1 transition-all duration-300"
    ...
    <section ref={ref} data-scene="gather-schedule" className="relative" style={{ ["--stage-vh" as string]: "85vh", height: `calc((${events.length} + 0.2) * var(--stage-vh))` }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center pt-32 md:pt-20 pb-8 box-border">
        <div className="w-full max-w-[1280px] mx-auto px-6 md:px-12">
          <motion.h3
            className="text-3xl md:text-5xl lg:text-6xl font-bold text-[#FFFFED] mb-12 leading-[1] tracking-[-0.01em]"
  ...
  return (
    <section id="connect" ref={ref} data-scene="gather-connect" className="relative scroll-mt-0 -mt-[min(20vh,120px)]" style={{ ["--stage-vh" as string]: "115vh", height: "var(--stage-vh)" }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <motion.div
          className="absolute top-1/3 left-1/4 w-72 h-72 rounded-full bg-[#D85325]/10 blur-[100px] pointer-events-none"
          animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.85, 0.5] }}
          transition={{ duration: 6, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-72 h-72 rounded-full bg-[#A9C0BF]/10 blur-[100px] pointer-events-none"
          animate={{ scale: [1, 1.3, 1], opacity: [0.4, 0.75, 0.4] }}
          transition={{ duration: 8, repeat: Infinity, delay: 2 }}
        />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(216,83,37,0.08)_0%,rgba(169,192,191,0.05)_40%,transparent_70%)]" />
...
function ConnectEyebrow({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <motion.span
      className="text-[#D85325] text-[10px] tracking-[0.5em] uppercase block mb-6"
...
function ConnectTitle({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <h2
      className="text-[3rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[7.5rem] font-bold text-[#FFFFED] leading-[0.95] tracking-[-0.02em] mb-6"
      style={{ fontFamily: "var(--font-display)" }}
    >
...
function ConnectQuote({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <motion.p
      className="text-lg md:text-xl text-[#FFFFED]/60 mb-12 italic"
...
function ConnectPills({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  const pills = [
    { icon: MapPin, text: "Bixby, Oklahoma", color: "#D85325", range: [0.22, 0.30] as [number, number] },
    { icon: Calendar, text: "Every Last Friday", color: "#A9C0BF", range: [0.25, 0.33] as [number, number] },
    { icon: Heart, text: "All Are Welcome", color: "#A9C0BF", range: [0.28, 0.36] as [number, number] },
  ]
  return (
...
function ConnectPill({
  ...
  return (
    ...
    >
      ...
      <span className="text-[#FFFFED]/85">{text}</span>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      ...
      <span className="relative flex flex-col items-start leading-tight">
        <span className="text-[10px] tracking-[0.35em] uppercase text-[#8A8280] group-hover:text-[#FFFFED] transition-colors">
          {name}
        </span>
        <span className="text-sm text-[#FFFFED] font-semibold" style={{ fontFamily: "var(--font-sans)" }}>
          {handle}
        </span>
      </span>
      <ArrowUpRight
