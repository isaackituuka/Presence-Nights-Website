...
export default function Activate26Layout({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd id="activate-26-event-jsonld" data={activate26EventJsonLd()} />
      <JsonLd
        id="activate-26-breadcrumb-jsonld"
